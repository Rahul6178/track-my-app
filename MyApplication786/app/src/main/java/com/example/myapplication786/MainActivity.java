    ...
    final BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent received) {
            ...
            if (mbundle != null) {
                ...
                if(flag == 1) {
                    Log.e("array list2", arrayList2 + "");

                    myadapter.getContents(MainActivity.this, arrayList1, arrayList2);
                ...
                {
                    flag = 1;
                    myadapter = new Myadapter(MainActivity.this,arrayList1,arrayList2);
                    listView.setAdapter(myadapter);
                }
